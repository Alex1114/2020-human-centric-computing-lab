...
class ICP(object):
    ...
    def best_fit_transform(self, model, target):
        ...
        # de mean
        t_P1d = target[0] - c_target
        t_P2d = target[1] - c_target
        t_P3d = target[2] - c_target
        m_target = [[t_P1d[0], t_P2d[0], t_P3d[0]], [
            t_P1d[1], t_P2d[1], t_P3d[1]], [t_P1d[2], t_P2d[2], t_P3d[2]]]

        m_P1d = model[0] - c_model
        m_P2d = model[1] - c_model
        m_P3d = model[2] - c_model
        m_model = [[m_P1d[0], m_P2d[0], m_P3d[0]], [
            m_P1d[1], m_P2d[1], m_P3d[1]], [m_P1d[2], m_P2d[2], m_P3d[2]]]
